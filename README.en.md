...
**Version 0.4.3 preserves complete Codex packages, including nested helpers, resources and links, and adds runtime integrity verification.** Update an existing checkout without cloning it again:
...
The final three commands apply to installations using Codex remote services. See [upgrade and recovery](docs/UPGRADE.md) for complete source and platform-package commands.
